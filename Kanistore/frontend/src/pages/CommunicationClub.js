...
import { FaComments, FaCalendarAlt, FaCamera, FaFileAlt, FaUsers } from 'react-icons/fa';

const CommunicationClub = () => {
  const sections = [
  ...
  return (
    <div style={styles.container}>
      <h2 style={styles.title}>Communication Club</h2>
...
export default CommunicationClub;
